...
<head>
    ...
    <?php wp_head(); ?>
    <?php get_template_part('partials/microsoft-clarity'); ?>
</head>
    ...
    <header class="site-header">
        <div class="container">
            <div class="quiz-header-inner">
                <div class="quiz-header-secure">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="var(--black)" viewBox="0 0 256 256">
                ...
                <a class="site-logo quiz-header-logo">
                ...
                <div class="call-specialist">
                    ...
                    <div class="call-specialist__dropdown" role="dialog" aria-label="Call Centers">
                        ...
                        <div class="call-specialist__list">
                            <a href="tel:18333227030" class="call-specialist__company">
                            ...
                            <a href="tel:18334367355" class="call-specialist__company">
                                <div class="call-specialist__logo">
